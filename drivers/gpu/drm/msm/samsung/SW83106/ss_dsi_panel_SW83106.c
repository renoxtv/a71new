...
static struct dsi_panel_cmd_set *ss_acl_on(struct samsung_display_driver_data *vdd, int *level_key)
{
	...
	if(vdd->br.cd_idx <= MAX_BL_PF_LEVEL){	/* ACL 15% */
		pcmds->cmds[3].msg.tx_buf[7] = 0x56;
		pcmds->cmds[3].msg.tx_buf[8] = 0xCE;
		pcmds->cmds[3].msg.tx_buf[9] = 0x46;
		pcmds->cmds[3].msg.tx_buf[10] = 0xBE;
	}
	else{		/* ACL 8% */
		pcmds->cmds[3].msg.tx_buf[7] = 0x69;
		pcmds->cmds[3].msg.tx_buf[8] = 0xE4;
		pcmds->cmds[3].msg.tx_buf[9] = 0x60;
